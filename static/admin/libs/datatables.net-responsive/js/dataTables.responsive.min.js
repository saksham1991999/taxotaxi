...
(function (c) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (m) {
        return c(m, window, document)
    }) : "object" === typeof exports ? module.exports = function (m, l) {
        m || (m = window);
        if (!l || !l.fn.dataTable) l = require("datatables.net")(m, l).$;
        return c(l, m, m.document)
    } : c(jQuery, window, document)
})(function (c, m, l, q) {
    function t(a, b, d) {
        var e = b + "-" + d;
        if (n[e]) return n[e];
        for (var c = [], a = a.cell(b, d).node().childNodes, b = 0, d = a.length; b < d; b++) c.push(a[b]);
        return n[e] = c
    }
    ...
    function r(a, b, d) {
        var e = b +
            "-" + d;
        if (n[e]) {
            for (var a = a.cell(b, d).node(), d = n[e][0].parentNode.childNodes, b = [], c = 0, g = d.length; c < g; c++) b.push(d[c]);
            d = 0;
            for (c = b.length; d < c; d++) a.appendChild(b[d]);
            n[e] = q
        }
    }
        ...
        i = function (a, b) {
            ...
            this.s.dt.settings()[0].responsive || (b && "string" === typeof b.details ? b.details = {
                ...
                b && !0 === b.details && (b.details = {
                    type: "inline"
                }), this.c = c.extend(!0, {}, i.defaults, o.defaults.responsive, b), a.responsive = this, this._constructor())
        };
    c.extend(i.prototype, {
        _constructor: function () {
            ...
            c(m).on("resize.dtr orientationchange.dtr", o.util.throttle(function () {
                var b = c(m).innerWidth();
                b !== e && (a._resize(), e = b)
            }));
            d.oApi._fnCallbackReg(d, "aoRowCreatedCallback", function (d) {
                -1 !== c.inArray(!1, a.s.current) && c(">td, >th",
                    d).each(function (d) {
                    d = b.column.index("toData", d);
                    !1 === a.s.current[d] && c(this).css("display", "none")
                })
            });
            b.on("destroy.dtr", function () {
                ...
                c.each(a.s.current, function (b, d) {
                    !1 === d && a._setColumnVis(b, !0)
                })
            });
            ...
            d = this.c.details;
            !1 !==
                d.type && (a._detailsInit(), b.on("column-visibility.dtr", function () {
            ...
            b.on("preXhr.dtr", function () {
                ...
                b.rows().every(function () {
                    this.child.isShown() && d.push(this.id(true))
                });
                b.one("draw.dtr", function () {
                    a._resizeAuto();
                    a._resize();
                    b.rows(d).every(function () {
                        a._detailsDisplay(this, false)
                    })
                })
            });
            b.on("init.dtr", function (d) {
                if (d.namespace === "dt") {
                    a._resizeAuto();
                    a._resize();
        ...
        _columnsVisiblity: function (a) {
            var b = this.s.dt,
                ...
                k = c.map(d, function (d, e) {
                    return !1 === b.column(e).visible() ? "not-visible" : d.auto && null === d.minWidth ? !1 : !0 === d.auto ? "-" : -1 !== c.inArray(a, d.includeIn)
                }),
                h = 0;
            e = 0;
            for (f = k.length; e < f; e++) !0 === k[e] && (h += d[e].minWidth);
            e = b.settings()[0].oScroll;
            e = e.sY || e.sX ? e.iBarWidth : 0;
            h = b.table().container().offsetWidth - e - h;
            e = 0;
            for (f = k.length; e < f; e++) d[e].control && (h -= d[e].minWidth);
            var s = !1;
            e = 0;
            for (f = g.length; e < f; e++) {
                var j = g[e].columnIdx;
                "-" === k[j] && (!d[j].control &&
                    d[j].minWidth) && (s || 0 > h - d[j].minWidth ? (s = !0, k[j] = !1) : k[j] = !0, h -= d[j].minWidth)
            }
            g = !1;
            e = 0;
            for (f = d.length; e < f; e++)
                if (!d[e].control && !d[e].never && !1 === k[e]) {
                    g = !0;
                    break
                } e = 0;
            for (f = d.length; e < f; e++) d[e].control && (k[e] = g), "not-visible" === k[e] && (k[e] = !1); - 1 === c.inArray(!0, k) && (k[0] = !0);
            return k
        },
                ...
                g = function (d, c, g, j) {
                    if (g)
                        if ("max-" === g) {
                            j = a._find(c).width;
                            c = 0;
                            for (g = b.length; c < g; c++) b[c].width <= j && f(d, b[c].name)
                        } else if ("min-" === g) {
                        j = a._find(c).width;
                        c = 0;
                        for (g = b.length; c < g; c++) b[c].width >= j && f(d, b[c].name)
                        ...
                        if ("not-" === g) {
                            c = 0;
                            for (g = b.length; c < g; c++) - 1 === b[c].name.indexOf(j) && f(d, b[c].name)
                        }
            ...
            e.each(function (a, d) {
                for (var e = a.className.split(" "), f = !1, i = 0, m = e.length; i < m; i++) {
                    ...
                    c.each(b, function (a, b) {
                        ...
                        e && (f = !0, e[2] === c[0] && e[3] === "-" + c[1] ? g(d, b.name, e[1], e[2] + e[3]) : e[2] === c[0] && !e[3] && g(d, b.name, e[1], e[2]))
                    })
                }
                f || (a.auto = !0)
            });
        ...
        _detailsInit: function () {
            ...
            a._tabIndexes();
            c(b.table().body()).on("keyup.dtr", "td, th",
                function (a) {
                    a.keyCode === 13 && c(this).data("dtr-keyboard") && c(this).click()
                });
            var e = d.target;
            if (e !== q || null !== e) c(b.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", "string" === typeof e ? e : "td, th", function (d) {
                if (c(b.table().node()).hasClass("collapsed") && c.inArray(c(this).closest("tr").get(0), b.rows().nodes().toArray()) !== -1) {
                    if (typeof e === "number") {
                        var g = e < 0 ? b.columns().eq(0).length + e : e;
                        if (b.cell(this).index().column !== g) return
                    }
                    g = b.row(c(this).closest("tr"));
                    d.type === "click" ? a._detailsDisplay(g,
                        false) : d.type === "mousedown" ? c(this).css("outline", "none") : d.type === "mouseup" && c(this).trigger("blur").css("outline", "")
                }
            })
        },
        _detailsObj: function (a) {
            ...
            return c.map(this.s.columns, function (c, f) {
                if (!c.never && !c.control) {
                    var g = d.settings()[0].aoColumns[f];
                    return {
                        className: g.sClass,
                        columnIndex: f,
        ...
        _resize: function (a) {
            ...
            for (h = f.length - 1; 0 <= h; h--)
                if (e <= f[h].width) {
                    g = f[h].name;
                    break
                } var j = this._columnsVisiblity(g);
            this.s.current = j;
            f = !1;
            h = 0;
            for (e = k.length; h < e; h++)
                if (!1 === j[h] && !k[h].never && !k[h].control && !1 === !d.column(h).visible()) {
                    f = !0;
                    break
                } c(d.table().node()).toggleClass("collapsed", f);
            var l = !1,
                n = 0;
            d.columns().eq(0).each(function (d, c) {
                !0 === j[c] && n++;
                if (a || j[c] !== i[c]) l = !0, b._setColumnVis(d, j[c])
            });
            l && (this._redrawChildren(), c(d.table().node()).trigger("responsive-resize.dt", [d, this.s.current]), 0 === d.page.info().recordsDisplay && c("td", d.table().body()).eq(0).attr("colspan", n));
            if ("inline" === this.c.details.type) {
                var o = c.inArray(!0, j);
                d.cells(null, function (a) {
                    return a !== o
                }, {
                    page: "current"
        ...
        _resizeAuto: function () {
            ...
            if (this.c.auto && -1 !== c.inArray(!0, c.map(b, function (a) {
                ...
                c.isEmptyObject(n) || c.each(n, function (b) {
                    b = b.split("-");
                    r(a, 1 * b[0], 1 * b[1])
                });
                a.table().node();
                ...
                if (f = a.table().footer()) {
                    var f = c(f.cloneNode(!1)).appendTo(d),
                        k = a.columns().footer().filter(function (b) {
                            return a.column(b).visible()
                        }).to$().clone(!1).css("display", "table-cell");
                    c("<tr/>").append(k).appendTo(f)
                }
        ...
        _responsiveOnlyHidden: function () {
            var a = this.s.dt;
            return c.map(this.s.current, function (b, c) {
        ...
        _setColumnVis: function (a, b) {
            ...
            d.column(a).nodes().to$().css("display",
                e);
            c.isEmptyObject(n) || d.cells(null, a).indexes().each(function (a) {
                r(d, a.row, a.column)
            })
        },
        _tabIndexes: function () {
            ...
            "number" === typeof e ? a.cells(null, e, {
                page: "current"
            }).nodes().to$().attr("tabIndex", d.iTabIndex).data("dtr-keyboard", 1) : ("td:first-child, th:first-child" === e && (e = ">td:first-child, >th:first-child"), c(e, a.rows({
                page: "current"
            }).nodes()).attr("tabIndex",
    ...
    i.display = {
        ...
        childRowImmediate: function (a, b, d) {
            if (!b &&
                a.child.isShown() || !a.responsive.hasHidden()) return a.child(!1), c(a.node()).removeClass("parent"), !1;
            a.child(d(), "child").show();
            c(a.node()).addClass("parent");
            return !0
        },
    ...
    i.renderer = {
        listHiddenNodes: function () {
            return function (a, b, d) {
                var e = c('<ul data-dtr-index="' + b + '" class="dtr-details"/>'),
                    f = !1;
                c.each(d, function (b, d) {
                    d.hidden && (c("<li " + (d.className ? 'class="' + d.className + '"' : "") + ' data-dtr-index="' + d.columnIndex + '" data-dt-row="' + d.rowIndex + '" data-dt-column="' + d.columnIndex + '"><span class="dtr-title">' +
                        d.title + "</span> </li>").append(c('<span class="dtr-data"/>').append(t(a, d.rowIndex, d.columnIndex))).appendTo(e), f = !0)
                });
                return f ? e : !1
            }
        },
        listHidden: function () {
            return function (a, b, d) {
                ...
                }).join("")) ? c('<ul data-dtr-index="' +
                    b + '" class="dtr-details"/>').append(a) : !1
            }
        },
        tableAll: function (a) {
            a = c.extend({
    ...
    p.register("responsive.hasHidden()", function () {
        ...
        return a._responsive ? -1 !== c.inArray(!1, a._responsive._responsiveOnlyHidden()) : !1
    });
    ...
    i.version = "2.2.4";
    c.fn.dataTable.Responsive = i;
    c.fn.DataTable.Responsive = i;
    c(l).on("preInit.dt.dtr", function (a, b) {
        if ("dt" ===
            a.namespace && (c(b.nTable).hasClass("responsive") || c(b.nTable).hasClass("dt-responsive") || b.oInit.responsive || o.defaults.responsive)) {
            var d = b.oInit.responsive;
            !1 !== d && new i(b, c.isPlainObject(d) ? d : {})
        }
    });
    return i
});